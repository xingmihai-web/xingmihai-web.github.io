export default {
  ...
  Title: '星觅海的博客',
  // 网站地址
  Site: 'https://xingmihai-web.github.io',
  // 网站副标题
  Subtitle: '一起慢慢进步.',
  // 网站描述
...
// <p><img src=/assets/images/tips.gif style=width:100%></p>
  // 首页打字机文案列表
  TypeWriteList: [
    '一起慢慢进步.',
  ...
  WebSites: [
    ...
    { text: '微信', link: 'https://img.xmhai.cn/v2/ROIwNPT.png', icon: 'WebSite_wechat' },
